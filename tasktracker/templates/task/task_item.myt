...
<span style="position: absolute; left: 0px; width: <% left %>px; overflow:hidden;" id = "sibling_dropzone_<% atask.id %>">
...
<span style="position: absolute; right: 0px; left: <% left %>px;" id = "child_dropzone_<% atask.id %>">&nbsp;
</span>
