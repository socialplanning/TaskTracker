...
def sortableColumn(field, fieldname = None, klass = None):
    span = """
    <th id="%s-heading" class="%s" onclick="sortBy('%s');">
    ...
    </th>""" % (field, klass or "%s-column" % field, field, field, fieldname or field, field, field, field)
    return span
